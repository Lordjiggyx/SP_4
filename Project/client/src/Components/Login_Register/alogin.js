        ...
        else
        {
            ...
            .then(res => {
                ...
                else
                {
                    ...
                    this.setState({step:1 ,admin:true})
                }
        ...
        switch(step)
        {
            ...
            <div>
                ...
                <h1> Enter the following details to Login</h1>
                    ...
                    {this.state.EmptyError==true && this.state.visible==true ? <Alert isOpen={this.state.visible} color="danger">Enter  All Fields</Alert> : null}
